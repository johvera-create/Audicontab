...
import { ArrowIcon, MailIcon, OfficialLogo, WhatsAppIcon } from "./icons";
      ...
      <div className="relative mx-auto max-w-7xl px-6 pb-10 pt-16">
        <div className="grid gap-12 md:grid-cols-12">
          ...
          <div className="md:col-span-5">
            <a href="#inicio" className="inline-block" aria-label="Volver al inicio">
              <OfficialLogo light className="h-[76px] w-auto" />
            </a>
            ...
            <ul className="mt-5 space-y-3 text-[14.5px] text-mist-300">
              ...
              <li>
                <a
                  ...
                  className="link-draw inline-flex items-center gap-2 break-all text-mist-300 hover:text-paper-50"
                >
                  <MailIcon className="h-4 w-4 shrink-0 text-brass-400" />
                  {CONTACT_EMAIL}
                </a>
              </li>
