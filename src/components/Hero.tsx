...
import { Eyebrow, MaskLines, Stat } from "./Reveal";
        ...
        <div className="ruled-lines px-6 py-1">
          {LEDGER_ENTRIES.map((e, i) => (
            <div
              ...
              style={{
                opacity: inView ? 1 : 0,
                transform: inView ? "none" : "translateX(26px)",
...
export default function Hero() {
  return (
    <section id="inicio" className="relative overflow-hidden bg-ink-950">
      ...
      <div
        aria-hidden="true"
        className="absolute inset-0 bg-[radial-gradient(820px_480px_at_78%_18%,rgba(229,173,67,0.14),transparent_65%),radial-gradient(700px_520px_at_8%_88%,rgba(61,106,153,0.22),transparent_60%)]"
      />
      ...
      <div className="relative mx-auto grid max-w-7xl gap-14 px-6 pb-20 pt-24 md:pt-32 lg:grid-cols-12 lg:gap-8 lg:pb-28">
        {/* Columna editorial */}
        <div className="lg:col-span-7">
          ...
          <h1 className="mt-7">
            <MaskLines
              className="font-display text-[2.85rem] font-extrabold leading-[1.04] tracking-tight text-paper-50 sm:text-6xl xl:text-[5.2rem]"
              lines={[
                "¿Necesitas",
                <>
                  Contador<span className="text-brass-400">?</span>
                </>,
              ]}
            />
          </h1>
