...
export default function WhatsAppFloat() {
  ...
  return (
    ...
    >
      <span className="pointer-events-none absolute right-full top-1/2 mr-4 -translate-y-1/2 whitespace-nowrap border border-brass-400/40 bg-ink-950 px-3.5 py-2 font-mono text-[11px] uppercase tracking-[0.16em] text-brass-300 opacity-0 shadow-xl transition-all duration-300 group-hover:-translate-x-1 group-hover:opacity-100">
