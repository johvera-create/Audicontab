...
export default function TaxCalendar() {
  ...
  return (
    <section id="calendario" className="relative overflow-hidden bg-ink-950 py-20 text-paper-100 md:py-28">
      ...
      <div
        aria-hidden="true"
        className="absolute inset-0 bg-[radial-gradient(760px_460px_at_85%_20%,rgba(37,99,235,0.18),transparent_62%),radial-gradient(600px_420px_at_5%_90%,rgba(30,58,138,0.25),transparent_60%)]"
      />
      ...
      <div className="relative mx-auto max-w-7xl px-6">
        ...
        <div className="mt-14 border-t border-paper-50/15">
          {deadlines.map((d, i) => {
            ...
            const first = i === 0;
            return (
              <Reveal key={d.id ?? `${d.code}-${d.freq}`} delay={i * 90} y={20}>
                <div
                ...
                >
                  ...
                  <div className="row-start-1 sm:row-auto">
                    <p className="tabular font-display text-4xl font-extrabold leading-none text-paper-50 sm:text-5xl">
                      {formatDay(d.date)}
                    </p>
                  ...
                  <div className="min-w-0">
                    <div className="flex flex-wrap items-center gap-x-3 gap-y-1.5">
                      <p className="text-[15.5px] font-semibold text-paper-50 sm:whitespace-normal sm:text-lg">
                        {d.label}
                      </p>
                      {d.badge && (
                        <span className="inline-block border border-amber-400/50 bg-amber-400/10 px-2 py-0.5 font-mono text-[9px] font-bold uppercase tracking-[0.12em] text-amber-300">
                          {d.badge}
                        </span>
                      )}
                    </div>
                    <p className="mt-1 font-mono text-[10.5px] uppercase tracking-[0.22em] text-mist-500">
        ...
        <div className="mt-8 flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
          <p className="max-w-xl font-mono text-[10.5px] leading-relaxed tracking-[0.08em] text-mist-500">
            * Fechas referenciales según calendario general del SII y Previred. Los vencimientos
